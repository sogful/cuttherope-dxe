...
#if ANDROID
        /// <summary>
        /// Initializes sizing directly from the android surface dimensions.
        /// Always fullscreen; reuses the letterbox/pillarbox path against the real surface.
        /// </summary>
        /// <param name="surfaceWidth">Surface width in pixels.</param>
        /// <param name="surfaceHeight">Surface height in pixels.</param>
        public void InitAndroid(int surfaceWidth, int surfaceHeight)
        {
            Rectangle surface = new(0, 0, surfaceWidth, surfaceHeight);
            _fullScreenRect = surface;
            _windowRect = surface;
            IsFullScreen = true;
            _fullScreenCropWidth = true;
            UpdateScaledView();
        }
#endif
        /*//////////////////////////// android /////////////////////////////////*/
