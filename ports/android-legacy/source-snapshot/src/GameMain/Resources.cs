...
namespace CutTheRopeDX.GameMain
{
    ...
    internal static class Resources
    {
        ...
        internal static class Img
        {
            ...
            public const string SubprojectLogo = "SubprojectLogo";
            public const string CustomBoxGray = "CustomBoxGray";
            public const string MenuLevelSelectionWide = "menu_level_selection_wide";
            public const string MenuBgrGray = "menu_bgr_gray";
