...
inline constexpr int GL_FLIP_NONE=1, GL_FLIP_H=4, GL_FLIP_V=2, GL_RGBA=3, GL_RGB8_A5=4, GL_RGB32_A3=5;
...
template<class... T> void glFlush(T...) { ++submittedframes; }
