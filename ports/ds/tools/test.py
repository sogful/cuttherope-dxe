...
subprocess.run([compiler, "-std=c++17", "-O2", "-Wall", "-Wextra", "-Werror", "-msse2", "-mfpmath=sse", "-ffp-contract=off",
                ...
                str(root / "source/simulation.cpp"), str(root / "source/mechanics.cpp"), str(root / "source/advanced.cpp"), str(root / "source/contraptions.cpp"), str(root / "source/devices.cpp"), str(root / "source/nocturnal.cpp"), str(root / "tests/simulation.cpp"), "-o", str(binary)], check=True)
...
subprocess.run([compiler, "-std=c++17", "-O2", "-Wall", "-Wextra", "-Werror", "-msse2", "-mfpmath=sse", "-ffp-contract=off",
                ...
                str(root / "source/mechanics.cpp"), str(root / "source/advanced.cpp"), str(root / "source/contraptions.cpp"), str(root / "source/devices.cpp"), str(root / "source/nocturnal.cpp"), str(root / "source/levelstore.cpp"), str(root / "tests/levels.cpp"), "-o", str(binary)], check=True)
result = json.loads(subprocess.check_output([str(binary)], text=True))
...
subprocess.run([compiler, "-std=c++17", "-O2", "-Wall", "-Wextra", "-Werror",
                "-I" + str(root / "include"), "-I" + str(root / "generated"),
                str(root / "source/simulation.cpp"), str(root / "source/mechanics.cpp"), str(root / "source/advanced.cpp"), str(root / "source/contraptions.cpp"), str(root / "source/devices.cpp"), str(root / "source/nocturnal.cpp"), str(root / "source/interface.cpp"), str(root / "source/progress.cpp"),
