...
assert len(results[0]) == len(results[1]) == 180000
...
report = {"maps": 150, "frames": len(results[0]), "divergentFrames": len(differences),
...
print("PASS: optimized/reference float-state hashes match over all 150 maps and 180,000 frames")
