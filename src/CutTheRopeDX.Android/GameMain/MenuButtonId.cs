...
namespace CutTheRopeDX.GameMain
{
    ...
    internal readonly record struct MenuButtonId(int Value) : IButtonIdentifier
    {
        ...
        /// <summary>
        /// Opens the Custom Box (imported levels) screen.
        /// </summary>
        public static readonly MenuButtonId CustomBox = MenuButton.CustomBox;

        /// <summary>
        /// Launches the system file picker to import custom level files.
        /// </summary>
        public static readonly MenuButtonId CustomAddLevel = MenuButton.CustomAddLevel;

        /// <summary>
        /// Navigates back from the Custom Box screen to pack selection.
        /// </summary>
        ...
        /// <summary>
        /// Tag used for dynamically generated custom-level buttons.
        /// </summary>
        private const int CustomLevelTag = 8 << 24;
        ...
        /// <summary>
        /// Creates an identifier for an imported custom-level button.
        /// </summary>
        /// <param name="customLevelIndex">Zero-based index into the imported level list.</param>
        /// <returns>A tagged menu button identifier for the given custom level.</returns>
        public static MenuButtonId ForCustomLevel(int customLevelIndex)
        {
            return new(CustomLevelTag | customLevelIndex);
        }

        /// <summary>
        /// Determines whether this identifier represents a dynamic custom-level button.
        /// </summary>
        /// <returns><see langword="true"/> when this is a custom-level button; otherwise <see langword="false"/>.</returns>
        public bool IsCustomLevelButton()
        {
            return (Value >> 24) == 8;
        }

        /// <summary>
        /// Gets the zero-based custom-level index when this identifier is a custom-level button.
        /// </summary>
        /// <returns>The custom-level index, or <c>-1</c> when this is not a custom-level button.</returns>
        public int GetCustomLevelIndex()
        {
            return IsCustomLevelButton() ? Value & IndexMask : -1;
        }
