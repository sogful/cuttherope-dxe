...
namespace CutTheRopeDX.GameMain
{
    internal sealed partial class GameScene
    {
        ...
        public void Reload()
        {
            ...
            CTRRootController cTRRootController = (CTRRootController)Application.SharedRootController();
            if (CustomLevels.PendingCustomMap != null)
            {
                // restarting an imported custom level: reload the same parsed XML
                XmlLoaderFinishedWithfromwithSuccess(CustomLevels.PendingCustomMap, "custom", true);
                return;
            }
        ...
        public void LoadNextMap()
        {
            ...
            if (CustomLevels.PendingCustomMap != null)
            {
                // custom levels have no "next"; stay on the current map
                return;
            }
            if (cTRRootController.IsPicker())
            {
